export const LegalSection = () => {
  return (
    <div>
      <h2 className="text-2xl font-bold mt-8 mb-4">12. Dispute Resolution and Arbitration</h2>
      <p className="font-semibold">12.1. Mandatory Arbitration:</p>
      <ul className="list-disc pl-6 mt-4">
        ...
        <li>Limited grounds for judicial review</li>
      </ul>

      <p className="font-semibold mt-4">12.2. Class Action and Jury Trial Waiver:</p>
      <ul className="list-disc pl-6 mt-4">
        <li>ALL disputes must be brought in an individual capacity</li>
        <li>NO class actions or representative proceedings</li>
        <li>NO joinder of claims with other users</li>
        <li>Arbitrator may not consolidate claims</li>
        <li>WAIVER of right to jury trial</li>
        <li>WAIVER of right to participate in class action</li>
        <li>Small claims court cases permitted for qualifying claims</li>
      </ul>
      ...
      <p className="font-semibold">14.1. Disclaimer of Warranties:</p>
      <ul className="list-disc pl-6 mt-4">
        <li>SERVICE PROVIDED "AS IS" WITHOUT ANY WARRANTIES</li>
        <li>NO WARRANTY OF MERCHANTABILITY OR FITNESS</li>
        <li>NO WARRANTY OF ACCURACY OR COMPLETENESS</li>
        <li>NO WARRANTY OF UNINTERRUPTED SERVICE</li>
        <li>NO WARRANTY REGARDING THIRD-PARTY SERVICES</li>
      </ul>

      <p className="font-semibold mt-4">14.2. Limitation of Damages:</p>
      <ul className="list-disc pl-6 mt-4">
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">15. Changes to Terms</h2>
      <p>15.1. Modification Process:</p>
      <ul className="list-disc pl-6 mt-4">
        <li>Terms may be updated at our sole discretion</li>
        ...
        <li>Users responsible for reviewing changes</li>
      </ul>
      ...
      <p className="mt-4">16.1. Legal Notices:</p>
      <ul className="list-disc pl-6 mt-4">
        <li>All legal notices must be in writing</li>
        <li>Notices must be sent via certified mail or courier</li>
